# Helper to convert Parsons problems from JSON format to code snippet format
...
if __name__ == "__main__":
    ...
    # output_file = "data/parsons_with_prob_description_old.py"
    input_file = "data/python-basics.json"
